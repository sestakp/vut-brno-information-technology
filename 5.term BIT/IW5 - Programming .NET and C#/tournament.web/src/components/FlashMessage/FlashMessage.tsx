...
import { setNotification, getNotificaion } from '../../features/notification/notificationSlice';
...
const FlashMessage = () => {
    ...
    const notification:Notification = useAppSelector(getNotificaion);
    ...
    const getIcon = (status: "" | "FAIL" | "SUCCESS" | "WARNING") => {
        switch (status) {
            case 'FAIL':
                return (
                    <svg
