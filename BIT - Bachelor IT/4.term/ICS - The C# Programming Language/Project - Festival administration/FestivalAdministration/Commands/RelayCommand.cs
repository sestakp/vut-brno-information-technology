...
namespace FestivalAdministration.Commands
{
    ...
    public class RelayCommand<T> : ICommand
    {
        ...
        public bool CanExecute(object parameter)
        {
            if (parameter is T typedParameter) return _canExecute?.Invoke(typedParameter) ?? true;
        ...
        public void Execute(object parameter)
        {
            if (parameter is T typedParameter) _execute?.Invoke(typedParameter);
        }
